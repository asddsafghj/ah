            ...
            if status[2] == "active" or status[2] == "فعال" then
              if database:get('getpro:'..msg.chat_id_) == "Active" then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> وضعیت دریافت عکس پروفایل از قبل بر روی حالت ✅ میباشد ! ', 1, 'md')
                end
              else
                if database:get('lang:gp:'..msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, '> Get profile photo has been changed to *active* ', 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, '> وضعیت دریافت عکس پروفایل بر روی حالت ✅ تنظیم شد !', 1, 'md')
                end
            ...
            if lockpt[2] == "edit" or lockptf[2] == "ویرایش پیام" then
              if not database:get('editmsg'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ویرایش پیام ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ویرایش پیام از قبل ✅ است ! ', 1, 'md')
                end
              end
            end
            if lockpt[2] == "cmd" or lockptf[2] == "حالت عدم جواب" then
              if not database:get('bot:cmds'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> حالت عدم جواب ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> حالت عدم جواب از قبل ✅ است ! ', 1, 'md')
                end
              end
            end
            if lockpt[2] == "bots" or lockptf[2] == "ربات" then
              if not database:get('bot:bots:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ورود ربات ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ورود ربات از قبل ✅ است ! ', 1, 'md')
                end
              end
            end
            if lockpt[2] == "flood" or lockptf[2] == "فلود" then
              if not database:get('anti-flood:'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فلود ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فلود از قبل ✅ است ! ', 1, 'md')
                end
              end
            end
            if lockpt[2] == "pin" or lockptf[2] == "سنجاق پیام" then
              if not database:get('bot:pin:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "> قفل سنجاق پیام ✅ شد ! ", 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "> قفل سنجاق پیام از قبل ✅ است ! ", 1, 'md')
                end
              end
            end
          end
            ...
            if unlockpt[2] == "flood" or unlockpts[2] == "فلود" then
              if database:get('anti-flood:'..msg.chat_id_) then
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل قلود از قبل ❎ است ! ', 1, 'md')
                end
              end
            end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          if text:match("^[Ll]ock gtime (%d+)$") then
            ...
            if database:get('lang:gp:'..msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "> قفل گروه [ همه چیز ] به مدت "..mutept[1].." ساعت ✅ شد !", 'md')
            end
          end
            ...
            if mutept[2] == "all" or  mutepts[2] == "گروه" then
              if not database:get('bot:muteall'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل گروه [ همه چیز ] ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل گروه [ همه چیز ] از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "text" or mutepts[2] == "متن" then
              if not database:get('bot:text:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل متن [ چت ] ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل متن [ چت ] از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "inline" or mutepts[2] == "دکمه شیشه ای" then
              if not database:get('bot:inline:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل دکمه شیشه ایی ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل دکمه شیشه ایی از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "photo" or mutepts[2] == "عکس" then
              if not database:get('bot:photo:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل عکس ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل عکس از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "spam" or mutepts[2] == "اسپم" then
              if not database:get('bot:spam:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل اسپم ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل اسپم از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "video" or mutepts[2] == "فیلم" then
              if not database:get('bot:video:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فیلم ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فیلم از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "gif" or mutepts[2] == "گیف" then
              if not database:get('bot:gifs:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل گیف ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل گیف از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "music" or mutepts[2] == "موزیک" then
              if not database:get('bot:music:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل موزیک ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل موزیک از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "voice" or mutepts[2] == "ویس" then
              if not database:get('bot:voice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ویس ✅ شد !', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ویس از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "links" or mutepts[2] == "لینک" then
              if not database:get('bot:links:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل لینک ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل لینک از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "location" or mutepts[2] == "موقعیت مکانی" then
              if not database:get('bot:location:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل موقعیت مکانی ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل موقعیت مکانی از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "tag" or mutepts[2] == "تگ" then
              if not database:get('tags:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل تگ ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل تگ از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "strict" or  mutepts[2] == "حالت سختگیرانه" then
              if not database:get('bot:strict'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> حالت [ سختگیرانه ] ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> حالت [ سختگیرانه ] از قبل ✅ است ! ', 1, 'md')
                end
              end
            end
            if mutept[2] == "file" or mutepts[2] == "فایل" then
              if not database:get('bot:document:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فایل ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فایل از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "hashtag" or mutepts[2] == "هشتگ" then
              if not database:get('bot:hashtag:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل هشتگ ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل هشتگ از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "contact" or mutepts[2] == "مخاطب" then
              if not database:get('bot:contact:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ارسال مخاطب ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ارسال مخاطب از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "webpage" or mutepts[2] == "صفحات اینترنتی" then
              if not database:get('bot:webpage:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ارسال صفحه اینترنتی ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل ارسال صفحه اینترنتی از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "farsi" or mutepts[2] == "نوشتار فارسی" then
              if not database:get('bot:arabic:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل نوشتار فارسی ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل نوشتار فارسی از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "english" or mutepts[2] == "نوشتار انگلیسی" then
              if not database:get('bot:english:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل نوشتار انگلیسی ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل نوشتار انگلیسی از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "sticker" or mutepts[2] == "استیکر" then
              if not database:get('bot:sticker:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل استیکر ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل استیکر از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "markdown" or mutepts[2] == "مدل نشانه گذاری" then
              if not database:get('markdown:lock'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل مدل نشانه گذاری ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل مدل نشانه گذاری از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "tgservice" or mutepts[2] == "سرویس تلگرام" then
              if not database:get('bot:tgservice:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل سرویس تلگرام ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل سرویس تلگرام از قبل ✅ است !', 1, 'md')
                end
              end
            end
            if mutept[2] == "fwd" or mutepts[2] == "فروارد" then
              if not database:get('bot:forward:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فروارد ✅ شد ! ', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل فروارد از قبل ✅ است !', 1, 'md')
                end
              end
            end
          end
            ...
            if unmutept[2] == "contact" or unmutepts[2] == "مخاطب" then
              if database:get('bot:contact:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, '> قفل مخاطب ❎ شد ! ', 1, 'md')
                end
